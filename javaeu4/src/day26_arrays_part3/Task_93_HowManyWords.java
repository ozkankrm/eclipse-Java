...
//		önce split ile space (" ") ten her word u array e çevirdik
//		sonra length ile kaç elemetn olduðunu bulduk. 
//		her bir element bir word e karþýlýk gelir.
		String[] arr = str.split(" ");
		
		System.out.println(arr.length);
		
		for(String value : arr) { // her bir wordu yazdýrdýk
			System.out.println(value);
		}
		
		System.out.println("-----------------------------");
		System.out.println(arr[5]); //pharmacy // 5 inci elementin hangi word a karþýlk geldiði
